package com.litmus7.inventorymanagementphase2.dao;
...
import com.litmus7.inventorymanagementphase2.constants.SQLConstants;
...
import com.litmus7.inventorymanagementphase2.util.DatabaseConnectionUtil;
...
public class InventoryDao {
	...
	public void insertInventory(List<Product> products) throws InventoryDaoException {
		...
		try(Connection conn = DatabaseConnectionUtil.getConnection()){
			...
			logger.error("Error during database connecntion : " + e.getMessage(), e);
